...
public class App {
    ...
    public static void menu(ArrayList<Cliente> usuarios){
        while(true){
            System.out.println("\n----------Menu de usuarios---------");
    ...
    public static void agregar_saldo(ArrayList<Cliente> usuarios){
        ...
        if(indice_cliente != -1) {
            ...
            int nuevo_saldo = Integer.parseInt(JOptionPane.showInputDialog(null,"Ingrese el numero de cedula:"));
    ...
    public static int buscar_cliente_cedula(ArrayList<Cliente> usuarios, String cedula){
    ...
    public static int buscar_cliente_nombre(ArrayList<Cliente> usuarios, String nombre){
        for(int i = 0; i < usuarios.size(); i++){
            Cliente usuario = usuarios.get(i);
